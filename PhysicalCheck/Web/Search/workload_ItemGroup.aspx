<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/ContentMasterPage.master"
    AutoEventWireup="true" CodeFile="workload_ItemGroup.aspx.cs" Inherits="Examination_customerArchive" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function Printrpt() {
            var sURL = "<%=ApplicationPath%>/Reports/Default.aspx?ReportKind=64";
    ...
    <div>
        <div class="l-navigationbars">
            <div class="l-navigationbars-l">
                <a href="#" style="left: 100px; text-decoration: none;">体检科室组合项查询 </a>
            </div>
        </div>
