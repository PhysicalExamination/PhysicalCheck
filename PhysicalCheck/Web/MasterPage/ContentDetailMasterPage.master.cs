...
public partial class MasterPage_ContentDetailMasterPage : System.Web.UI.MasterPage
{
    #region 属性
    /// <summary>
    /// 返回虚拟目录路径
    ...
    private void ClientInitial() {
        ...
        String script = ApplicationPath + "/Scripts/jquery-1.8.3.js";
        lblScript1.Text = String.Format(scriptFmt, script);

        script = ApplicationPath + "/Scripts/jquery-ui-1.9.2.custom.js";
        lblScript2.Text = String.Format(scriptFmt, script);

        script = ApplicationPath + "/Scripts/InitialInput.js";
        lblScript3.Text = String.Format(scriptFmt, script);

        script = ApplicationPath + "/Scripts/common.js";
        lblScript4.Text = String.Format(scriptFmt, script);

        script = ApplicationPath + "/Scripts/DatePicker/WdatePicker.js";
        lblScript5.Text = String.Format(scriptFmt, script);

        script = ApplicationPath + "/Scripts/jquery.validationEngine-zh_CN.js";
        lblScript6.Text = String.Format(scriptFmt, script);

        script = ApplicationPath + "/Scripts/jquery.validationEngine.js";
