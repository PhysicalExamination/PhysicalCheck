...
public partial class Reports_Default : BasePage {
    ...
    protected override void OnLoad(EventArgs e) {
        ...
        if (!IsPostBack) {
            ...
            if (ReportKind == "4") BuildHealthCard(RegisterNo);//健康卡
            ...
            if (ReportKind == "10") BuildHealthCertificate(RegisterNo);//健康证
            ...
            if (ReportKind == "65") BuildIndustryDataTotals();
            if (ReportKind == "66") BuildPackageDataTotals();
            if (ReportKind == "67") BuildTradeDataTotals();
            if (ReportKind == "68") BuildRegionDataTotals();
        }
    }
    ...
    private void BuildHealthCertificate(String RegisterNo) {
        if (String.IsNullOrWhiteSpace(RegisterNo)) return;
        m_Registration.SavePrintDate(RegisterNo);
    ...
    public void BuildHealthCard1(String RegisterNo) {
        if (String.IsNullOrWhiteSpace(RegisterNo)) return;
        //String p = @"";
        List<HealthCardInfo> Registrations = new List<HealthCardInfo>();
        var RegInfo = m_Registration.GetRegistration(RegisterNo);
        ...
        WebReport1.ReportFile = Server.MapPath("HealthCard1.frx");
        WebReport1.Report.RegisterData(Registrations, "CardData");
        WebReport1.Prepare();
    }
    ...
    private void BuildHealthCardBatch() {
        ...
        WebReport1.Report.RegisterData(Registrations, "CardData");
        WebReport1.Prepare();
        foreach (HealthCardInfo data in Registrations) {
            m_Registration.SavePrintDate(data.RegisterNo);
        }
    }
    ...
    private void BuildIndustryDataTotals() {
        Int32 IndustryID = Convert.ToInt32(Request.Params["IndustryID"]);
        DateTime StartDate = Convert.ToDateTime(Request.Params["StartDate"]);
        DateTime EndDate = Convert.ToDateTime(Request.Params["EndDate"]);
        String IndustryName = Request.Params["IndustryName"];
        ReportUtility ReportUtil = new ReportUtility();
        var GroupData = ReportUtil.GetIndustryDataTotals(IndustryID, StartDate, EndDate);
        Report report = new Report();
        String ReportTitle = "武威市" + IndustryName + "行业从业人员体检统计情况";
        report.Load(Server.MapPath("DataTotals.frx"));
    ...
    private void BuildPackageDataTotals() {
        Int32 PackageID = Convert.ToInt32(Request.Params["PackageID"]);
        DateTime StartDate = Convert.ToDateTime(Request.Params["StartDate"]);
        DateTime EndDate = Convert.ToDateTime(Request.Params["EndDate"]);
        String PackageName = Request.Params["PackageName"];
        ReportUtility ReportUtil = new ReportUtility();
        var GroupData = ReportUtil.GetPackageDataTotals(PackageID, StartDate, EndDate);
        Report report = new Report();
        String ReportTitle = "武威市" + PackageName + "套餐从业人员体检统计情况";
        report.Load(Server.MapPath("DataTotals.frx"));
        report.SetParameterValue("ReportTitle", ReportTitle);
        report.SetParameterValue("StartDate", StartDate);
        report.SetParameterValue("EndDate", EndDate);
    ...
    private void BuildTradeDataTotals() {
        String TradeCode = Request.Params["TradeCode"];
        DateTime StartDate = Convert.ToDateTime(Request.Params["StartDate"]);
        DateTime EndDate = Convert.ToDateTime(Request.Params["EndDate"]);
        String TradeName = Request.Params["TradeName"];
        ReportUtility ReportUtil = new ReportUtility();
        var GroupData = ReportUtil.GetTradeDataTotals(TradeCode, StartDate, EndDate);
        Report report = new Report();
        String ReportTitle = "武威市" + TradeName + "从业人员体检统计情况";
        report.Load(Server.MapPath("DataTotals.frx"));
        report.SetParameterValue("ReportTitle", ReportTitle);
        report.SetParameterValue("StartDate", StartDate);
        report.SetParameterValue("EndDate", EndDate);
    ...
    private void BuildRegionDataTotals() {
        String RegionCode = Request.Params["RegionCode"];
        DateTime StartDate = Convert.ToDateTime(Request.Params["StartDate"]);
        DateTime EndDate = Convert.ToDateTime(Request.Params["EndDate"]);
        String RegionName = Request.Params["RegionName"];
        ReportUtility ReportUtil = new ReportUtility();
        var GroupData = ReportUtil.GetRegionDataTotals(RegionCode, StartDate, EndDate);
        Report report = new Report();
        String ReportTitle = "武威市" + RegionName + "从业人员体检统计情况";
        report.Load(Server.MapPath("DataTotals.frx"));
        report.SetParameterValue("ReportTitle", ReportTitle);
        report.SetParameterValue("StartDate", StartDate);
        report.SetParameterValue("EndDate", EndDate);
