<%@ page title="" language="C#" masterpagefile="~/MasterPage/ContentMasterPage.master" autoeventwireup="true" inherits="Examination_ExaminationReportPage, App_Web_cukzgset" theme="redmond" %>
                    ...
                    <asp:Repeater ID="ReportRepeater" runat="server">
                        ...
                        <ItemTemplate>
                            <tr class="tr1" onmouseover="javascript:this.className;this.className='tr3';" onmouseout="javascript:this.className='tr1'">
                                ...
                                <td class="VLine" align="center">
                                    <asp:Literal ID="lblDeptName" runat="server" Text=' <%# Eval("DeptName")%>' />
                                </td>
                                <td class="VLine" align="center">
