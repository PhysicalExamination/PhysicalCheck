<%@ page language="C#" masterpagefile="~/MasterPage/ContentMasterPage.master" autoeventwireup="true" inherits="SysConfig_ItemGroupPage, App_Web_dez24fga" theme="redmond" %>
                ...
                <ContentTemplate>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td class="HVLine">
                                <asp:TextBox CssClass="inputCss" ID="txtGroupName" runat="server" />
                            </td>
                            <td class="HVLine">
                                检查科室
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="VLine">
                                <asp:TextBox CssClass="inputCss" ID="txtPrice" runat="server" />
                            </td>
                            <td class="VLine">
                                正常描述
                            </td>
