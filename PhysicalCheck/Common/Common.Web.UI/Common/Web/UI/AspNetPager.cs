...
namespace Common.Web.UI
{
    ...
    [PersistChildren(false), DefaultEvent("PageChanged"), Designer(typeof(PagerDesigner)), ToolboxData("<{0}:AspNetPager runat=server></{0}:AspNetPager>"), ParseChildren(false), DefaultProperty("PageSize"), ANPDescription("desc_AspNetPager"), AspNetHostingPermission(SecurityAction.Demand, Level = AspNetHostingPermissionLevel.Minimal)]
    public class AspNetPager : Panel, INamingContainer, IPostBackEventHandler, IPostBackDataHandler
    {
        ...
        private void CreateMoreButton(HtmlTextWriter writer, int pageIndex)
        {
            ...
            if ((this.PagingButtonType == Common.Web.UI.PagingButtonType.Image) && (this.MoreButtonType == Common.Web.UI.PagingButtonType.Image))
            {
        ...
        private void CreateNavigationButton(HtmlTextWriter writer, string btnname)
        {
            if ((this.ShowFirstLast || ((btnname != "first") && (btnname != "last"))) && (this.ShowPrevNext || ((btnname != "prev") && (btnname != "next"))))
            {
                ...
                int num;
                string str = "";
                bool flag2 = (this.PagingButtonType == Common.Web.UI.PagingButtonType.Image) && (this.NavigationButtonType == Common.Web.UI.PagingButtonType.Image);
                    ...
                    if (this.ShowDisabledButtons || !flag)
                    {
                        ...
                        if (flag2)
                        {
                            if (!flag)
                            {
                                ...
                                writer.RenderBeginTag(HtmlTextWriterTag.A);
                                writer.AddAttribute(HtmlTextWriterAttribute.Src, this.ImagePath + this.ButtonImageNameExtension + btnname + this.ButtonImageExtension);
                                writer.AddAttribute(HtmlTextWriterAttribute.Border, "0");
                                if (this.ButtonImageAlign != ImageAlign.NotSet)
                                {
                                    writer.AddAttribute(HtmlTextWriterAttribute.Align, this.ButtonImageAlign.ToString());
                            ...
                            {
                                writer.AddAttribute(HtmlTextWriterAttribute.Src, this.ImagePath + this.DisabledButtonImageNameExtension + btnname + this.ButtonImageExtension);
                                writer.AddAttribute(HtmlTextWriterAttribute.Border, "0");
                                if (this.ButtonImageAlign != ImageAlign.NotSet)
                                {
                                    writer.AddAttribute(HtmlTextWriterAttribute.Align, this.ButtonImageAlign.ToString());
        ...
        private void CreateNumericButton(HtmlTextWriter writer, int index)
        {
            ...
            if ((this.PagingButtonType == Common.Web.UI.PagingButtonType.Image) && (this.NumericButtonType == Common.Web.UI.PagingButtonType.Image))
            {
                this.writeSpacingStyle(writer);
                if (!isCurrent)
                {
        ...
        private void WriteCellAttributes(HtmlTextWriter writer, bool leftCell)
        {
            ...
            if (((this.ShowCustomInfoSection == Common.Web.UI.ShowCustomInfoSection.Left) && leftCell) || ((this.ShowCustomInfoSection == Common.Web.UI.ShowCustomInfoSection.Right) && !leftCell))
            {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if ((this.CloneFrom != null) && (string.Empty != this.CloneFrom.Trim()))
            {
                ...
                if (pager == null)
                {
                    string str = Common.Web.UI.SR.GetString("clonefromexeption");
                    if (str == null)
                    {
                        str = "The control \" %controlID% \" does not exist or is not of type Common.Web.UI.AspNetPager!";
                    }
                    throw new ArgumentException(str.Replace("%controlID%", this.CloneFrom), "CloneFrom");
                }
                if ((pager.cloneFrom != null) && (this == pager.cloneFrom))
                {
                    string message = Common.Web.UI.SR.GetString("recusiveclonefrom");
                    if (message == null)
                    {
        ...
        {
            if ((this.PageCount > 1) && ((this.ShowInputBox == Common.Web.UI.ShowInputBox.Always) || ((this.ShowInputBox == Common.Web.UI.ShowInputBox.Auto) && (this.PageCount >= this.ShowBoxThreshold))))
            {
                StringBuilder builder = new StringBuilder("<script language=\"Javascript\"><!--\n");
                string str = Common.Web.UI.SR.GetString("checkinputscript");
                if (str != null)
                {
                ...
                string str2 = Common.Web.UI.SR.GetString("keydownscript");
        ...
        public override void RenderBeginTag(HtmlTextWriter writer)
        {
            ...
            writer.WriteLine();
            //writer.Write("<!-- ");
            //writer.Write("AspNetPager V1.0.0 for VS2005  Copyright:2003-2006");
            //writer.WriteLine(" -->");
            if (!flag)
            {
                writer.Write("<!--");
                writer.Write(Common.Web.UI.SR.GetString("autohideinfo"));
                writer.Write("-->");
            }
            else
            {
                base.RenderBeginTag(writer);
                if ((this.ShowCustomInfoSection == Common.Web.UI.ShowCustomInfoSection.Left) || (this.ShowCustomInfoSection == Common.Web.UI.ShowCustomInfoSection.Right))
                {
        ...
        protected override void RenderContents(HtmlTextWriter writer)
        {
            ...
            {
                if (this.ShowCustomInfoSection == Common.Web.UI.ShowCustomInfoSection.Left)
                {
                ...
                if ((this.ShowInputBox == Common.Web.UI.ShowInputBox.Always) || ((this.ShowInputBox == Common.Web.UI.ShowInputBox.Auto) && (this.PageCount >= this.ShowBoxThreshold)))
                {
                ...
                if (this.ShowCustomInfoSection == Common.Web.UI.ShowCustomInfoSection.Right)
                {
                    writer.RenderEndTag();
                    this.WriteCellAttributes(writer, false);
                    writer.RenderBeginTag(HtmlTextWriterTag.Td);
				...
				writer.RenderBeginTag(HtmlTextWriterTag.Span);
				writer.Write(String.Format("  共 {0} 记录 每页 {1} 条记录 共 {2} 页", RecordCount,PageSize,PageCount));
				writer.RenderEndTag();
            }
        }
        ...
        public override void RenderEndTag(HtmlTextWriter writer)
        {
            ...
            writer.WriteLine();
            //writer.Write("<!-- ");
            //writer.Write("AspNetPager 1.0.0 for VS2005 End");
            //writer.WriteLine(" -->");
            writer.WriteLine();
        }
        ...
        [Category("Behavior"), Browsable(true), DefaultValue(false), ANPDescription("desc_AlwaysShow"), Themeable(false)]
        ...
        [Browsable(true), Themeable(false), ANPDescription("desc_ButtonImageExtension"), DefaultValue(".gif"), Category("Appearance")]
        ...
        [Category("Appearance"), ANPDescription("desc_ButtonImageNameExtension"), Themeable(false), DefaultValue((string)null), Browsable(true)]
        ...
        [DefaultValue(false), Category("Behavior"), ANPDescription("desc_CloneFrom"), Browsable(true), Themeable(false), TypeConverter(typeof(AspNetPagerIDConverter))]
        ...
        [Category("Appearance"), DefaultValue((string)null), ANPDescription("desc_CpiButtonImageNameExtension"), Themeable(false), Browsable(true)]
        ...
        [Category("Appearance"), ANPDescription("desc_CssClass"), Browsable(true), DefaultValue((string)null)]
        ...
        [ANPDescription("desc_CurrentPageButtonStyle"), Category("Appearance"), Browsable(true), DefaultValue((string)null)]
        ...
        [DefaultValue(1), DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden), ReadOnly(true), Browsable(false), ANPDescription("desc_CurrentPageIndex"), ANPCategory("cat_Paging")]
        ...
        [ANPDescription("desc_CustomInfoClass"), Browsable(true), Category("Appearance"), DefaultValue((string)null)]
        ...
        [Browsable(true), ANPDescription("desc_CustomInfoHTML"), Themeable(false), Category("Appearance"), DefaultValue((string)null)]
        ...
        [ANPDescription("desc_CustomInfoSectionWidth"), DefaultValue(typeof(Unit), "40%"), Browsable(true), Category("Appearance")]
        ...
        [ANPDescription("desc_CustomInfoStyle"), Browsable(true), Category("Appearance"), DefaultValue((string)null)]
        ...
        [ANPDescription("desc_CustomInfoTextAlign"), Category("Appearance"), DefaultValue(1), Browsable(true)]
        ...
        [Category("Appearance"), ANPDescription("desc_DisabledButtonImageNameExtension"), DefaultValue((string)null), Browsable(true), Themeable(false)]
        ...
        [DefaultValue(false), Browsable(true), Themeable(false), Category("Behavior"), ANPDescription("desc_EnableUrlWriting")]
        ...
        [ANPDescription("desc_ImagePath"), Browsable(true), DefaultValue((string)null), Category("Appearance")]
        ...
        [Browsable(true), DefaultValue((string)null), ANPDescription("desc_InputBoxClass"), ANPCategory("cat_InputBox")]
        ...
        [ANPDescription("desc_InputBoxStyle"), ANPCategory("cat_InputBox"), DefaultValue((string)null), Browsable(true)]
        ...
        [ANPDescription("desc_InvalidPIErrorMsg"), Browsable(true), ANPDefaultValue("def_InvalidPIErrorMsg"), Category("Data"), Themeable(false)]
        public string InvalidPageIndexErrorMessage
        {
            get
            {
                ...
                return Common.Web.UI.SR.GetString("def_InvalidPIErrorMsg");
            }
            set
            {
        ...
        [DefaultValue("&gt;&gt;"), Browsable(true), Themeable(false), ANPDescription("desc_LastPageText"), ANPCategory("cat_Navigation")]
        ...
        [ANPCategory("cat_Navigation"), DefaultValue(0), ANPDescription("desc_MoreButtonType"), Browsable(true), Themeable(false)]
        public Common.Web.UI.PagingButtonType MoreButtonType
        {
            get
            {
                if (this.cloneFrom != null)
                ...
                if (obj2 != null)
                {
                    return (Common.Web.UI.PagingButtonType)obj2;
                }
        ...
        [ANPDescription("desc_NavigationButtonType"), ANPCategory("cat_Navigation"), DefaultValue(0), Browsable(true), Themeable(false)]
        public Common.Web.UI.PagingButtonType NavigationButtonType
        {
            get
            {
                if (this.cloneFrom != null)
        ...
        [ANPDescription("desc_NavigationToolTipTextFormatString"), ANPDefaultValue("def_NavigationToolTipTextFormatString"), Browsable(true), Themeable(false), ANPCategory("cat_Navigation")]
        public string NavigationToolTipTextFormatString
        {
            get
            {
                ...
                if (this.ShowNavigationToolTip)
                {
                    return Common.Web.UI.SR.GetString("def_NavigationToolTipTextFormatString");
                }
                return null;
            }
            set
        ...
        [Themeable(false), DefaultValue("&gt;"), Browsable(true), ANPDescription("desc_NextPageText"), ANPCategory("cat_Navigation")]
        ...
        [ANPCategory("cat_Navigation"), ANPDescription("desc_NumericButtonCount"), DefaultValue(10), Browsable(true), Themeable(false)]
        ...
        [ANPCategory("cat_Navigation"), ANPDescription("desc_NBTFormatString"), Themeable(false), DefaultValue(""), Browsable(true)]
        ...
        public Common.Web.UI.PagingButtonType NumericButtonType
        {
            get
            {
                if (this.cloneFrom != null)
        ...
        [Browsable(true), Category("Data"), Themeable(false), ANPDescription("desc_PIOutOfRangeMsg"), ANPDefaultValue("def_PIOutOfRangerMsg")]
        public string PageIndexOutOfRangeErrorMessage
        {
            get
            {
                ...
                return Common.Web.UI.SR.GetString("def_PIOutOfRangerMsg");
            }
            set
            {
        ...
        [Browsable(true), DefaultValue(typeof(Unit), "5px"), Themeable(false), ANPDescription("desc_PagingButtonSpacing"), ANPCategory("cat_Navigation")]
        ...
        [ANPDescription("desc_PagingButtonType"), ANPCategory("cat_Navigation"), Browsable(true), Themeable(false), DefaultValue(0)]
        public Common.Web.UI.PagingButtonType PagingButtonType
        {
            get
            {
                if (this.cloneFrom != null)
                ...
                return Common.Web.UI.PagingButtonType.Text;
            }
            set
            {
        ...
        [ANPCategory("cat_Navigation"), ANPDescription("desc_PrevPageText"), DefaultValue("&lt;"), Themeable(false), Browsable(true)]
        ...
        [DefaultValue(0), Browsable(false), ANPDescription("desc_RecordCount"), Category("Data")]
        ...
        [ANPDescription("desc_ShowBoxThreshold"), Browsable(true), Themeable(false), DefaultValue(30), ANPCategory("cat_InputBox")]
        ...
        [Category("Appearance"), Browsable(true), Themeable(false), ANPDescription("desc_ShowCustomInfoSection"), DefaultValue(0)]
        public Common.Web.UI.ShowCustomInfoSection ShowCustomInfoSection
        {
            get
            {
                if (this.cloneFrom != null)
                ...
                if (obj2 != null)
                {
                    return (Common.Web.UI.ShowCustomInfoSection)obj2;
                }
                return Common.Web.UI.ShowCustomInfoSection.Never;
            }
            set
            {
        ...
        [DefaultValue(true), Browsable(true), ANPCategory("cat_Navigation"), ANPDescription("desc_ShowDisabledButtons"), Themeable(false)]
        ...
        [DefaultValue(true), Themeable(false), ANPCategory("cat_Navigation"), Browsable(true), ANPDescription("desc_ShowFirstLast")]
        ...
        [ANPDescription("desc_ShowInputBox"), Themeable(false), ANPCategory("cat_InputBox"), DefaultValue(1), Browsable(true)]
        public Common.Web.UI.ShowInputBox ShowInputBox
        {
            get
            {
                if (this.cloneFrom != null)
                ...
                if (obj2 != null)
                {
                    return (Common.Web.UI.ShowInputBox)obj2;
                }
                return Common.Web.UI.ShowInputBox.Auto;
            }
            set
            {
        ...
        [Themeable(false), ANPDescription("desc_ShowNavigationToolTip"), Browsable(true), ANPCategory("cat_Navigation"), DefaultValue(false)]
        ...
        [ANPDescription("desc_ShowPageIndex"), Browsable(true), ANPCategory("cat_Navigation"), DefaultValue(true), Themeable(false)]
        ...
        [Themeable(false), Browsable(true), ANPDescription("desc_ShowPrevNext"), ANPCategory("cat_Navigation"), DefaultValue(true)]
        ...
        [ANPCategory("cat_InputBox"), ANPDescription("desc_SubmitButtonClass"), Browsable(true), DefaultValue((string)null)]
        ...
        [ANPDescription("desc_SubmitButtonStyle"), Browsable(true), DefaultValue((string)null), ANPCategory("cat_InputBox")]
        ...
        [ANPDescription("desc_SubmitButtonText"), ANPCategory("cat_InputBox"), Browsable(true), DefaultValue("go"), Themeable(false)]
        ...
        [ANPDescription("desc_TextAfterInputBox"), DefaultValue((string)null), Browsable(true), ANPCategory("cat_InputBox"), Themeable(false)]
        ...
        [ANPCategory("cat_InputBox"), ANPDescription("desc_TextBeforeInputBox"), Themeable(false), Browsable(true), DefaultValue((string)null)]
        ...
        [DefaultValue("page"), ANPDescription("desc_UrlPageIndexName"), Browsable(true), ANPCategory("cat_Paging")]
        ...
        [ANPDescription("desc_UrlPaging"), DefaultValue(false), Browsable(true), ANPCategory("cat_Paging")]
        ...
        [Themeable(false), Browsable(true), ANPDescription("desc_UrlRewritePattern"), Category("Behavior"), DefaultValue((string)null)]
